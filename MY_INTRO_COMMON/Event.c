...
#define EVNT_MEM_UNIT_NOF_BITS  (sizeof(EVNT_MemUnit)*8) //8
...
void EVNT_Init(void) {
  uint8_t i;
  uint8_t a = sizeof(EVNT_Events);
  uint8_t b = sizeof(EVNT_Events[0]);
  i = 0;
  do {
